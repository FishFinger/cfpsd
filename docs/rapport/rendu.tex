...
Les fichiers générés contiennent l'entête de l'email et le message. La détection d'un nouvel email s'effectue en repérant un début de ligne contenant la chaine de caractères \og \texttt{File - }\fg{}.
